  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-event-event-form-event-form-module"], {
    ...
    function srcAppPagesEventEventFormEventFormPageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var EventFormPage = /*#__PURE__*/function () {
        function EventFormPage(activatedRoute, eventService, router, alertController) {
        ...
        _createClass(EventFormPage, [{
          ...
          value: function createEvent() {
            ...
            this.eventService.createEvent(this.event).subscribe(function (res) {
              if (res.status) {
                _this3.navigateAlert('¡EVENTO CREADO!', 'Creaste un nuevo evento', 'OK', 'events');
              } else {
                _this3.navigateAlert('¡ERROR AL CREAR!', 'Hubo un problema al intentar crear el evento', 'OK', 'events');
              }
            }, function (err) {
          ...
          value: function updateEvent() {
            ...
            this.eventService.updateEvent(this.event).subscribe(function (res) {
              if (res.status) {
                _this4.navigateAlert('¡EVENTO MODIFICADO!', 'Modificaste este evento', 'OK', 'events');
              } else {
                _this4.navigateAlert('¡ERROR AL MODIFICAR!', 'Hubo un problema al modificar este evento', 'OK', 'events');
              }
            }, function (err) {
              _this4.navigateAlert('ERROR DE SERVIDOR', err.message, 'OK', 'events');
            });
          }
        }]);
